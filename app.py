...
OPENAI_API_KEY ="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"
...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["Hello, Tell me your product requirements and I will suggest you a product"]
...
with container:
    with st.form(key='my_form', clear_on_submit=True):
        user_input = st.text_input("Query:", placeholder="What product are you looking for", key='input')
